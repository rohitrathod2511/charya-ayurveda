...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(drawer)/books` | `/books` | `/(drawer)/diet-hygiene` | `/diet-hygiene` | `/(drawer)/diet` | `/diet` | `/(drawer)/exercise` | `/exercise` | `/(drawer)/importance` | `/importance` | `/(drawer)/meditation` | `/meditation` | `/(drawer)/privacy` | `/privacy` | `/(drawer)/yoga` | `/yoga` | `/(tabs)/advice` | `/advice` | `/(tabs)/disorders` | `/disorders` | `/(tabs)/home` | `/home` | `/(tabs)/prakriti` | `/prakriti` | `/components/AdminLoginModal` | `/components/BottomNavigation` | `/components/GlobalAyurvedaStats` | `/components/Sidebar` | `/data/disorders.json` | `/data/symptoms.json`;
  // prettier-ignore
  type DynamicRoutes<T extends string> = `/symptoms/${SingleRoutePart<T>}`;
  // prettier-ignore
  type DynamicRouteTemplate = `/symptoms/[id]`;
